      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><span className="text-gray-400 hover:text-white cursor-pointer">Programming</span></li>
              <li><span className="text-gray-400 hover:text-white cursor-pointer">Design</span></li>
              <li><span className="text-gray-400 hover:text-white cursor-pointer">Marketing</span></li>
              <li><span className="text-gray-400 hover:text-white cursor-pointer">Business</span></li>
              <li><span className="text-gray-400 hover:text-white cursor-pointer">Languages</span></li>
            </ul>
          </div>
